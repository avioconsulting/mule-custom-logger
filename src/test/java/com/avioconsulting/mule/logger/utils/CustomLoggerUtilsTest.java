...
public class CustomLoggerUtilsTest {
  ...
  public void initLogger() {
    ...
    logger = CustomLoggerUtils.initLogger(CustomLoggerConfiguration.DEFAULT_CATEGORY, "",
        CustomLoggerTimerScopeOperations.DEFAULT_CATEGORY_SUFFIX).getName();
    Assert.assertEquals(CustomLoggerConfiguration.DEFAULT_CATEGORY + "."
        + CustomLoggerTimerScopeOperations.DEFAULT_CATEGORY_SUFFIX, logger);
    ...
    logger = CustomLoggerUtils.initLogger(CustomLoggerConfiguration.DEFAULT_CATEGORY + ".", "com.test", "")
        .getName();
